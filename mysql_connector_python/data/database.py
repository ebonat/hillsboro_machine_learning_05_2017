...
class DatabaseConnector(AbstractDatabaseConnector):
    ...
    def get_exception_message(self):
        try:    
    #         sys.exc_info() – system exception information function
    ...
    #         extract_tb() - return a list of up to limit “pre-processed” stack trace entries extracted from the traceback object
